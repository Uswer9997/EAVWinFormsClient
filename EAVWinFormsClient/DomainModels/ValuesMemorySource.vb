...
Public Class ValuesMemorySource
    ...
    Public Overrides Function GetValues(ByVal idEntity As Integer) As List(Of ValueDTO)
        Select Case idEntity
            Case 101
                Return _values.Where(Function(x) x.Name = "Цвета")
            Case 102
                Return _values.Where(Function(x) x.Name = "Вкусы")
            Case 103
                Return _values.Where(Function(x) x.Name = "VINs")
        End Select
    ...
    Private Sub Initialize()
        ...
        _values.Add(New ValueDTO() With {.Id = 205, .Name = "Цвета", .Value = "Сладкий"})
        _values.Add(New ValueDTO() With {.Id = 206, .Name = "Цвета", .Value = "Горький"})
